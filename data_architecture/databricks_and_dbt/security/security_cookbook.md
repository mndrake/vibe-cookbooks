...
> **On Databricks (interactive notebooks or jobs):** Unity Catalog SQL runs directly in notebooks or on a SQL Warehouse — no local tooling needed for the native SQL examples.
>
