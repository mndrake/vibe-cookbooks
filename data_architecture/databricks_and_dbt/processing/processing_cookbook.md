...
> **On Databricks (interactive notebooks or jobs):** PySpark and Delta Lake are pre-installed with every Databricks Runtime — no `pip install` is needed to run the PySpark and SQL examples on a cluster.
>
