...
- Running dbt SQL models (dbt-databricks supports SQL Warehouses for SQL materializations)
...
The boundary case is **dbt**: dbt SQL models run on SQL Warehouses; dbt Python models require a cluster. A project using both must configure two compute targets in `profiles.yml`.
...
- The vault is primarily a landing zone and all reporting is done against a separate gold/mart layer that is pre-computed by dbt
...
- [AutomateDV (dbt Data Vault package) — Documentation](https://automate-dv.com/)
- [Data Vault Cookbook](../data_vault/)
- [Performance Cookbook — AutomateDV Incremental Loading](./performance_cookbook.md)
...
- [Delta Lake Performance — Databricks Documentation](https://docs.databricks.com/en/delta/optimizations/index.html)
