...
> **Scope:** Databricks native tooling only — PySpark, Spark SQL, Delta Lake, Lakeflow Spark Declarative Pipelines (formerly Delta Live Tables / DLT), Databricks Workflows, and Databricks Asset Bundles. Does not cover dbt, AutomateDV, or Data Vault.
