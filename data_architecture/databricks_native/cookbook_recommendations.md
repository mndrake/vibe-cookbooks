...
> **Scope:** Databricks native tooling only — PySpark, Spark SQL, Delta Lake, Delta Live Tables, Databricks Workflows, and Databricks Asset Bundles. Does not cover dbt, AutomateDV, or Data Vault.
