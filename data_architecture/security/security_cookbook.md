...
- `security_cookbook.md` — role definitions and privilege scope decisions
...
- `security_cookbook.md` — when to use dynamic views versus native Unity Catalog masking
...
- `security_cookbook.md` — satellite-level security boundary design
...
- `security_cookbook.md` — native masks versus dynamic views trade-offs
...
- `security_cookbook.md` — governance enforcement layer decisions
...
- [ ] Pipeline service principal has no Metastore Admin, Catalog Owner, or `ALL PRIVILEGES` grants; `SHOW GRANTS` returns only the minimum privilege set documented in `security_cookbook.md`
