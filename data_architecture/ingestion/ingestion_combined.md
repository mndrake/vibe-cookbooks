...
| Kafka / Azure Event Hubs | Structured Streaming | [Streaming Ingestion: Structured Streaming](#streaming-ingestion-structured-streaming) |
...
| **Structured Streaming** | Sub-minute latency ingestion from Kafka or Azure Event Hubs; event-driven architectures where consumer lag must be minimised; stateful aggregations with watermarking | The source is cloud storage files rather than a message bus; your team lacks the operational capability to manage streaming job recovery |
